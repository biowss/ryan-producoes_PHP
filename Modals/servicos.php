<div class="container mt-5 flex flow-column">
  ...
  <table class="table table-stripped">
    ...
    <tbody>
      <?php 
        $query = "SELECT * from servicos ORDER BY name";
      ...
      ?>
          <tr>
            <td><?php  echo($rowServico['name']); ?></td>
            <td><?php  echo($rowServico['description']); ?></td>
            <td>
              <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalEditarServicos" data-id="<?php print $rowServico['id'] ?>" data-name="<?php print $rowServico['name'] ?>" data-description="<?php print $rowServico['description'] ?>">
            ...
            <td>
              <button type="button" class="btn btn-danger"  data-toggle="modal" data-target="#modalDeletarServicos" data-id="<?php print $rowServico['id'] ?>" data-name="<?php print $rowServico['name'] ?>">
      ...
      <div class="modal-body">  
        ...
        <form action="../controll/ctr_admin.php" method="POST">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="description" name="txtDesc" required></textarea> 
          </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">  
        ...
        <form action="../controll/ctr_admin.php" method="POST">
          <input type="hidden" id="recipient-id" name="edit_service" value="">
          <div class="form-group">
            <label for="nome">Name:</label>
            <input type="email" class="form-control" id="recipient-name" name="txtName" required>
          </div>
          <div class="form-group">
            <label for="idade">Descrição:</label>
            <textarea class="form-control" id="recipient-description" name="txtDesc" required></textarea>
          </div>
          <div class="modal-footer">
            <button type="button" class="bg-white" data-dismiss="modal">Cancelar</button>
            <button type="submit" class="">Cadastrar</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">  
        ...
        <form action="../controll/ctr_admin.php" method="POST">
          <input type="hidden" id="recipient-id" name="delete_service" value="">
          <div class="form-group">
            <label for="nome">Serviço:</label>
            <input type="email" class="form-control" id="recipient-name" name="txtName" disabled>
          </div>
...
$('#modalEditarServicos').on('show.bs.modal', function(event) {
  ...
  modal.find('#recipient-description').val(recipientDesc);
});
