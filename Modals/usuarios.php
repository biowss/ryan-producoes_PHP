<div class="container mt-5 flex flow-column">
  <h2>Usuários</h2>
  ...
  <table class="table table-stripped">
    ...
    <tbody>
      <?php 
        $query = "SELECT * from usuarios ORDER BY admin, user";
      ...
      ?>
          <tr>
            <td><?php  echo($rowUsuario['user']); ?></td>
            <td><?php  echo($rowUsuario['password']); ?></td>
            <td><?php  echo($rowUsuario['admin'] ? "Sim" : "Não"); ?></td>
            <td>
              <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalEditarUsuarios" data-id="<?php print $rowUsuario['id'] ?>" data-username="<?php print $rowUsuario['user'] ?>" data-password="<?php print $rowUsuario['password'] ?>" data-admin="<?php print $rowUsuario['admin'] ?>">
            ...
            <td>
              <button type="button" class="btn btn-danger"  data-toggle="modal" data-target="#modalDeletarUsuarios" data-id="<?php print $rowUsuario['id'] ?>" data-username="<?php print $rowUsuario['user'] ?>">
      ...
      <div class="modal-body">  
        ...
        <form action="../controll/ctr_admin.php" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="email" class="form-control" id="user" name="txtUser" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="idade">Nível de Acesso:</label>
            <select class="form-control" name="txtAdmin" required>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">  
        ...
        <form action="../controll/ctr_admin.php" method="POST">
          <input type="hidden" id="recipient-id" name="edit_user" value="">
          <div class="form-group">
            <label for="nome">User:</label>
            <input type="email" class="form-control" id="recipient-user" name="txtUser" required>
          </div>
          <div class="form-group">
            <label for="idade">Password:</label>
            <input type="password" class="form-control" id="recipient-password" name="txtPassword" required> 
          </div>
          <div class="form-group">
            <label for="idade">Nivel de Acesso:</label>
            <select class="form-control" id="recipient-admin" name="txtAdmin" required>
              <option value="">Selecione...</option>
              <option value="1">Administrador</option>
              <option value="0">Cliente</option>
            </select>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">  
        ...
        <form action="../controll/ctr_admin.php" method="POST">
          <input type="hidden" id="recipient-id" name="delete_user" value="">
          <div class="form-group">
            <label for="nome">Usuario:</label>
            <input type="email" class="form-control" id="recipient-user" name="txtUser" disabled>
          </div>
